...
class CommentsController implements \Anax\DI\IInjectionAware
{
    ...
    public function createDatabaseAction()
    {
        ...
        $this->db->execute([
            1,
            'Exakt vad händer och hur långt kommer du?
            När folk skrivit att den inte startar har dom menat allt från död dator till att deras favorit program i Windows inte startar.',
            1,
            null,
            8,
            $now
         ...
         $this->db->execute([
            2,
            'Om folk bara brydde sig om att läsa innan de köper saker....
            https://www.asus.com/se/Motherboards/B85MG/HelpDesk_CPU/
            *Before using the new Intel 4th Gen Core processors, we suggest that you first download the BIOS updater for new Intel 4th Gen Core Processors and then update the BIOS using this tool.
            Det innebär att sålänge du inte uppdaterar bios, så kommer din processor inte att funka, det är därför det inte startar -garanterat.',
            2,
            null,
            3,
            $now
