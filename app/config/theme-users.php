...
return [
   ...
   /** 
    ...
    [
        ...
        'template' => 'me/header', 
        'data'     => [
            'siteTitle' => "Markus Dybeck",
            'siteTagline' => "- En sida för att visa användarfunktioner.",
        ], 
        'sort'     => -1
    ],
    ['region' => 'footer', 'template' => 'me/footer-grid', 'data' => [], 'sort' => -1],
    ...
    'data' => [
        ...
        'title_append' => ' | nojs a web template',

        // Stylesheets
        'stylesheets' => ['css/anax-users/style.php'],
